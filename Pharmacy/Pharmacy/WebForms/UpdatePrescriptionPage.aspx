<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/PharmacyMaster.Master" AutoEventWireup="true" CodeBehind="UpdatePrescriptionPage.aspx.cs" Inherits="Pharmacy.WebForms.UpdatePrescriptionPage" %>
            ...
            <div class="col-sm-6 table-responsive">
                <asp:GridView CssClass="table table-bordered table-hover" ID="GridViewDrugItems" runat="server" AutoGenerateColumns="False" CellPadding="3" GridLines="Vertical" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" DataSourceID="SqlDataSourceDrugItemsList" OnSelectedIndexChanged="GridViewDrugItems_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="drugName" HeaderText="Drug Name" SortExpression="drugName" />
                        <asp:BoundField DataField="prescriptionQuantity" HeaderText="Quantity" SortExpression="prescriptionQuantity" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceDrugItemsList" runat="server" ConnectionString="<%$ ConnectionStrings:PharmacyConnectionString %>" SelectCommand="SELECT t1.drugId, t1.prescriptionQuantity, t1.instructions, t2.drugName FROM PrescriptionItems AS t1 LEFT JOIN DrugsAndMedication AS t2 ON t1.drugId = t2.drugId WHERE ([prescriptionId] = @prescriptionId)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="prescriptionId" QueryStringField="vPresId" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>             
        </div>
