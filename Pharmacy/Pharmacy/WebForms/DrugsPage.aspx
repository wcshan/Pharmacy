...
<asp:Content ID="body" ContentPlaceHolderID="contentbody" runat="server">
    <div class="container">
        <div class="row" style="margin-top: 10px">
            <div class="col-sm-12">
                <h2 style="font-family: Rockwell; text-align: center; color: #0a5b64;">Drugs</h2>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom:10px; margin-top:20px">
            ...
            <div class="col-sm-6 text-right">
                <asp:LinkButton CssClass="btn btn-success" ID="btnAdd" runat="server" Width="110px" data-toggle="modal" data-target="#addDrugModal"><span class="fa fa-user-plus"></span>&nbsp;&nbsp;Add</asp:LinkButton>&nbsp;&nbsp;                
                <asp:LinkButton CssClass="btn btn-warning" ID="btnUpdate" runat="server" Width="110px" data-toggle="modal" data-target="#updateDrugModal"><span class="fa fa-edit"></span>&nbsp;&nbsp;Update</asp:LinkButton>&nbsp;&nbsp;                
                <asp:LinkButton CssClass="btn btn-danger" ID="btnDelete" runat="server" Width="110px" data-toggle="modal" data-target="#deleteDrugModal"><span class="fa fa-trash"></span>&nbsp;&nbsp;Delete</asp:LinkButton>                
            </div>
        </div>   
        <div class="row">
