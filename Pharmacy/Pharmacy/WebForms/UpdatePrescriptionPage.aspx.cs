...
{
    public partial class UpdatePrescriptionPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                txPrescriptionId.Text = Request.QueryString["vPresId"];
                ...
                loadData.LoadDataToUpdate(this);
            }            
        }
        ...
        protected void btnAddInputSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DT.Columns.Add("prescriptionQuantity");
                ...
                foreach (GridViewRow row in GridViewDrugItems.Rows)
                {
                    ...
                    DR["prescriptionQuantity"] = row.Cells[3].Text;
                ...
                else
                {
                    ...
                    newDR["prescriptionQuantity"] = txQuantity.Text;
        ...
        {
            GridViewDrugItems.DataSourceID = "";
        ...
        protected void btnConfirmComplete_Click(object sender, EventArgs e)
        {
            ...
            {
                ClassPrescription updatePrescription = new ClassPrescription();
                updatePrescription.UpdatePrescription(this);
            }
        }
    }
}